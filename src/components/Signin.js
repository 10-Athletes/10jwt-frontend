...
class Signin extends Component {
  ...
  handleSubmit = (event) => {
    ...
    fetch(url, { method: "POST", body: formData })
      ...
      .then(
        (res) => (
          console.log(res.jwt), window.localStorage.setItem("jwt", res.jwt)
        )
      )
  ...
  handleRegisterSubmit = (event) => {
    ...
    if (errorsFound.errorsFound === 0) {
      fetch(url, { method: "POST", body: formData })
        .then(() => fetch(url2, { method: "POST", body: formDataToken }))
        // eslint-disable-next-line
        .then((res) => res.json())
        .then(
          (res) => (
        ...
        .catch(
          setTimeout(
            () => this.setState({ errors: ["Username already in use"] }),
            1500
          )
        );
    } else {
      ...
      <Container fluid style={{ marginTop: "5%" }}>
        <Row>
          ...
          <Col xl="6">
            ...
            >
              <span className="ten-logo">
                <span style={{ letterSpacing: "-10px" }}>1</span>0
              </span>
              <span className="ten-logo-athletes">Athletes</span>
            </div>
            <div className="d-none d-xl-block text-center">
              <span
                className="descriptive-tagline-big"
                style={{
                  height: "7vh",
                  fontSize: "5vh",
                  fontFamily: "boogaloo",
              ...
              >
                Play Sports, Get Ranked
              </span>
            </div>
            <div
              className="d-block d-xl-none text-center pt-5 m-5"
              style={{ height: "4vh", fontFamily: "boogaloo", fontSize: "4vh" }}
            >
              <span className="ten-logo">
                <span style={{ letterSpacing: "-4px" }}>1</span>0
              </span>
              <span className="ten-logo-athletes">Athletes</span>
              <br />
              <span
                className="descriptive-tagline-small"
            ...
            <Card
              className="border-0 d-none d-xl-block"
              style={{
          ...
          <Col xl="1"></Col>
          <Col className="mt-3 mt-xl-2 pt-xl-2" xl="3">
            <div>
              <span
                  ...
                  <div id="inlineSlot " align="center" className="">
                    ...
                    <Row>
                      <Col xs="12">
                        <Button
                          size="lg"
                          className="signupButton my-4 w-50"
                          variant="success"
